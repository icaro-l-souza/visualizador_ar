...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // CÓDIGO CORRIGIDO (dentro de aplicarFiltros)
    function aplicarFiltros() {
        let tempSensores = [...allSensores];

        // Lógica de filtro (seu código original aqui)...
        ...
        createPagination(); // <--- ADICIONE A CHAMADA AQUI
        changePage(1);      // E depois mude para a página 1
    }
    ...
    let changing = false;
    // CÓDIGO CORRIGIDO (dentro de changePage)
    function changePage(pageNumber) {
        ...
        // Lógica para ativar a linha (que agora vai funcionar)
    ...
    // =========================================================================
    // ALTERAÇÃO PRINCIPAL: FILTROS EM TEMPO REAL
    // =========================================================================
...
// Bloco do Particles.js mantido separado, como no seu original.
